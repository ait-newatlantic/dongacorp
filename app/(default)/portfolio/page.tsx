                ...
                <div className="mb-8">
                  ...
                  <div className="space-y-6">
                    ...
                    <div>
                      ...
                      <input
                        type="text"
                        value="DONG A IMPORT EXPORT TRANSPORT SERVICE TRADING CORPORATION"
                        readOnly
                        className="w-full rounded-lg border border-gray-300 bg-gray-50 px-4 py-2"
                      />
                    </div>
                  ...
                  <div className="space-y-6">
                    ...
                    <div>
                      ...
                      <div className="flex items-center gap-3 rounded-lg border border-gray-300 bg-gray-50 px-4 py-2">
                        ...
                        <span>info@dongacorp.com.vn</span>
                      </div>
                    </div>
                    ...
                    <div>
                      ...
                      <div className="flex items-center gap-3 rounded-lg border border-gray-300 bg-gray-50 px-4 py-2">
                        ...
                        <span>www.dongacorp.com.vn</span>
                      </div>
                    </div>
                    ...
                    <div>
                      ...
                      <div className="flex items-start gap-3 rounded-lg border border-gray-300 bg-gray-50 px-4 py-2">
                        <svg
                        ...
                        <span>
                          156 Nam Ky Khoi Nghia, SaiGon Ward, HoChiMinh City,
                          Viet Nam
                        </span>
                      </div>
                    </div>
