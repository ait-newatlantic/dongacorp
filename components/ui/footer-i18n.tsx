  ...
  return (
    <footer>
      <div className="mx-auto max-w-6xl px-4 sm:px-6">
        ...
        >
          ...
          <div className="space-y-2 sm:col-span-12 lg:col-span-4">
            ...
            <div className="text-sm text-gray-600">{t("footer.address")}</div>
            <div className="text-sm text-gray-600">
              <a href="mailto:contact@dongacorp.com.vn">
                contact@dongacorp.com.vn
              </a>
            </div>
            <div className="text-sm text-gray-600">{t("footer.taxcode")}</div>
          </div>
      ...
      <div className="relative -mt-16 h-60 w-full" aria-hidden="true">
        <div className="pointer-events-none absolute left-1/2 -z-10 -translate-x-1/2 text-center text-[348px] font-bold leading-none before:bg-gradient-to-b before:from-gray-200 before:to-gray-100/30 before:to-80% before:bg-clip-text before:text-transparent before:content-[attr(data-content)] after:absolute after:inset-0 after:bg-gray-300/70 after:bg-clip-text after:text-transparent after:mix-blend-darken after:content-[attr(data-content)] after:[text-shadow:0_1px_0_white]" data-content={t("footer.bigtext")}></div>
        {/* Phát sáng */}
        <div
